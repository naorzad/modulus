...
def process_run(
    ...
    M = global_context_unnorm[0]
    Re = 10**global_context_unnorm[1]
    dynamic_pressure = calculate_dynamic_pressure(M, Re)
    ...
    try:
        ...
        Pressure_Coefficient = node_attributes["Pressure_Coefficient"]
        pressure_ref = node_attributes["Pressure"]
        shear_stress_Coefficient = node_attributes["Skin_Friction_Coefficient"]
        shear_stress_ref = shear_stress_Coefficient * dynamic_pressure
